...
# Role-level parameter distributions (means + std) for agent sampling
ROLE_PARAM_DISTRIBUTIONS = {
    "Crowd": {
        "base_activity": 0.3,
        "base_activity_std": 0.1,
        "conformity": 0.8,
        "conformity_std": 0.05,
        "sensitivity_reward": 0.6,
        "sensitivity_reward_std": 0.1,
        "sensitivity_risk": 0.8,
        "sensitivity_risk_std": 0.1,
        "reach_factor": 1.0,
        "reach_factor_std": 0.05,
    },
    "KOL": {
        "base_activity": 1.2,
        "base_activity_std": 0.1,
    ...
    "Troll": {
        ...
        "sensitivity_risk_std": 0.05,
        "reach_factor": 1.1,
        "reach_factor_std": 0.1,
    },
    "BrandOfficial": {
        "base_activity": 0.3,
        "base_activity_std": 0.05,
        "conformity": 0.6,
        "conformity_std": 0.05,
        "sensitivity_reward": 0.5,
        "sensitivity_reward_std": 0.05,
